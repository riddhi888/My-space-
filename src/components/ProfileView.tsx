      ...
      <div className="px-4 space-y-3">
        ...
        {activeTab === 'top8' && (
          <div className="space-y-2.5">
            <div className="flex items-center justify-between text-xs">
              ...
              {onOpenAddFriend && (
                <button
                  ...
                  className="text-pink-400 hover:text-pink-300 font-mono text-[11px] flex items-center gap-1"
                >
            ...
            {user.top8Friends && user.top8Friends.length > 0 ? (
              ...
              <div className="p-8 rounded-2xl bg-[#120c29] border border-purple-800/40 text-center space-y-3">
                <div className="w-12 h-12 mx-auto rounded-full bg-purple-950/60 border border-purple-800/50 flex items-center justify-center text-pink-400">
                ...
                {onOpenAddFriend && (
                  <button
                    id="profile-top8-add-friend-btn"
                    onClick={onOpenAddFriend}
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              {onOpenAddFriend && (
                <button
                  onClick={onOpenAddFriend}
                  className="px-3 py-2 rounded-xl bg-pink-500/20 hover:bg-pink-500 text-pink-300 hover:text-white border border-pink-500/30 text-xs font-semibold flex items-center gap-1.5 transition-all shrink-0"
                >
                  <UserPlus className="w-3.5 h-3.5" />
                  <span>Add Friend</span>
                </button>
            ...
            {filteredFriendsList.length > 0 ? (
              ...
              <div className="p-8 rounded-2xl bg-[#120c29] border border-purple-800/40 text-center space-y-3">
                ...
                {onOpenAddFriend && (
                  <button
                    id="profile-allfriends-add-friend-btn"
                    onClick={onOpenAddFriend}
                    className="px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-pink-500 to-purple-600 text-white text-xs font-semibold shadow-md hover:scale-105 transition-all inline-flex items-center gap-1.5"
                  >
                    <UserPlus className="w-3.5 h-3.5" />
